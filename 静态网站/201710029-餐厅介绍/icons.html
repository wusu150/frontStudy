...
<html lang="en">
<head>
<title>Dine a Hotels and Restaurants Category Bootstrap Responsive website Template | Web Icons :: w3layouts</title>
...
<body> 
	...
	<div class="banner">
		...
		<div class="header">
			<div class="container">
				<div class="logo">
					<h1><a href="index.html">Dine</a></h1>
				</div> 
				<div class="menu">
		...
		<div class="banner-text w3labout-bnr"> 
			<div class="container">  
				<h2><a href="index.html">Home</a> / Web Icons</h2>   
			</div>
		</div>
		<!-- //banner-text -->
	</div>
